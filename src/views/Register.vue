<template>
    ...
    <div class="board">
        ...
        <n-form ref="formRef" :rules="rules" :model="user">
            ...
            <n-form-item path="password" style="position:absolute;left:70px;top:190px;width:350px;">
                <n-input v-model:value="user.password" size="large" round type="password" placeholder="密码" />
            </n-form-item>
            <n-form-item path="repeatPassword" style="position:absolute;left:70px;top:260px;width:350px;">
                <n-input v-model:value="user.repeatPassword" size="large" round type="password" placeholder="重新输入密码" />
            </n-form-item>
            <n-form-item path="role" style="position:absolute;left:70px;top:330px;width:350px;">
                <n-radio-group v-model:value="user.role" name="radiogroup">
                    <n-space>
                        <n-radio v-for="ro in roles" :key="ro.role" :value="ro.value">
                            {{ ro.role }}
                        </n-radio>
                    </n-space>
                </n-radio-group>
